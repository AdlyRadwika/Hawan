...
function getLoc(e){
    ...
    .then((data) => {
        ...
        document.querySelector("#owl").innerHTML = `
            <div class="card w-100">
            <h1 class="card-header">${data.days[1].datetime}</h1>
                <div class="card-body">
                    <div class="locInfo">
                        <div class="conds">
                            <img src="assets/icons2/${data.days[1].icon}.svg" class="weatherIcon2 mx-auto">
                            <div class="desc">
                                <h4>${data.days[1].description}</h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-4">
                                <h5>Max Temp.</h5>
                                <p>${data.days[1].tempmax}°C</p>
                            </div>
                            <div class="col-4">
                                <h5>Avg Temp.</h5>
                                <p>${data.days[1].temp}°C</p>
                            </div>
                            <div class="col-4">
                                <h5>Min Temp.</h5>
                                <p>${data.days[1].tempmin}°C</p>
                            </div>    
                        </div>
                    </div>  
                </div>
